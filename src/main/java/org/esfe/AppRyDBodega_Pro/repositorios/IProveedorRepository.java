...
public interface IProveedorRepository extends JpaRepository<Proveedor, Integer> {
    ...
    Page<Proveedor> findByNombreContainingIgnoreCaseOrNombreEmpresaContainingIgnoreCaseOrderByNombreAsc(String nombre, String nombreEmpresa, Pageable pageable);
